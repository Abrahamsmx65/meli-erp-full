...
describe("planearTramos", () => {
  it("la primera vez cubre 90 días en tramos de 7, del más reciente al más viejo", () => {
    const t = planearTramos({ desde: null, hasta: null }, "2026-09-01");
  ...
  it("si pasaron días sin sincronizar, el tramo reciente crece hasta hoy", () => {
    const t = planearTramos({ desde: "2026-06-04", hasta: "2026-08-20" }, "2026-09-01");
    expect(t[0]).toEqual({ desde: "2026-08-14", hasta: "2026-09-01", tipo: "reciente" });
  });

  it("si quedó a medias hacia atrás, sigue desde donde iba", () => {
    const t = planearTramos({ desde: "2026-08-19", hasta: "2026-09-01" }, "2026-09-01");
