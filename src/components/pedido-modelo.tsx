      ...
      <table className="datos">
        <thead>
          <tr>
            ...
            <th className="num" title="Unidades realmente vendidas en MELI los últimos 30 días, sin corrección">
              Vendido MELI real
            </th>
            <th className="num" title="Demanda corregida por agotamiento y tendencia (la que usa el cálculo)">
              Vta MELI/mes
            </th>
            <th className="num" title="Unidades realmente vendidas en Amazon los últimos 30 días, sin corrección">
              Vendido AMZ real
            </th>
            <th
              className="num"
