    ...
    <div className="grid gap-5">
      ...
      <div className="tarjeta overflow-x-auto">
        <table className="tabla">
          <thead>
            <tr><th>Evento</th><th>Fecha</th><th className="text-right">Precio</th><th className="text-right">Pagados / pedidos / capacidad</th><th>Venta</th><th></th></tr>
          </thead>
          <tbody>
            ...
            {eventos.map((e) => (
              <tr key={e.id}>
                ...
                <td className="text-right">{pesos(e.precio)}</td>
